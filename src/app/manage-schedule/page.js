...
const ManageSchedulePage = () => {
  ...
  return (
    <>
      ...
      <PasswordModal open={adminPwdModal && !adminAuthorized} title="Admin Passwort" message="Bitte Admin Passwort eingeben" onSubmit={handleAdminPwd} onCancel={()=>{ window.location.href='/'; }} />
    </>
  );
};
